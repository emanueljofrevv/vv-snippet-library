...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    getGroups
    Customer:       VisualVault
    Purpose:        The purpose of this web service is to give an example on how to call and manage the repose of getGroups.
    Parameters:     The following represent variables passed into the function:
                    Groups: Array of groups that are going to be search.
    Return Object:
                    outputCollection[0]: Status
                    outputCollection[1]: Short description message
                    outputCollection[2]: Groups Data
    Psuedo code: 
              1° Get the list of groups that are going to be searched.
              2° Concatenate the names of the groups.
              3° Call getGroups.
              4° Measure the response.
              5° Send the reponse in outputCollection.

    Date of Dev:   01/04/2022
    Last Rev Date: 01/04/2022

    Revision Notes:
     01/04/2022 - Agustina Mannise:  First Setup of the script
    */
    ...
    **********/
    ...
    try {
        const groupNames = `'VaultAccess','VaultAdmins'`;

        const groupsData = {
            q: "[name] IN (" + groupNames + ")",
        };

        shortDescription = `Get Groups: ${groupNames}`;
        let getGroupsResponse = await vvClient.groups
            .getGroups(groupsData)
            .then((res) => parseRes(res))
            .then((res) => checkMetaAndStatus(res, shortDescription))
            .then((res) => checkDataPropertyExists(res, shortDescription));

        //Use the variable getGroupsResponse to extract the data of the groups.

        outputCollection[0] = "Success";
        outputCollection[1] = "Success short description here";
        outputCollection[2] = getGroupsResponse.data;
    } catch (error) {
