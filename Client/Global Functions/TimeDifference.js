...
const dateEnd = new Date(stopDate);
...
const startString = dateStart.toLocaleDateString().replace(/\u200E/g, "") + ", " + startTime;
const endString = dateEnd.toLocaleDateString().replace(/\u200E/g, "") + ", " + stopTime;

const timeStart = new Date(startString);
const timeEnd = new Date(endString);
