/*
    ...
    11/25/2022 - Agustina Mannise: Fixed error related to date format on V5.
*/

if (PassedControlValue && ValidationType) {
    PassedControlValue = PassedControlValue.substring(0,10)
    ...
    if (ComparisonValue) {
        ComparisonValue = ComparisonValue.substring(0,10)
